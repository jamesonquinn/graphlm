...
gginc(1:2,by1var.seq(l, adjustedData=stages(list(),F), connection=stages(list(),F), rawData=stages(list(),F), line=stages(list(),F), loess=stages(list(),F),rug=stages(list(),F)))
